...
class WofPage extends StatelessWidget {
  const WofPage({Key? key}) : super(key: key);
...
class __FormState extends State<_Form> {
  ...
  final nombrel = "World of Tanks";
  final descripcionl =
      "Este F2P pasa por una fórmula rápida, inmediata accesible y divertida, con una gran cantidad de tanques de diferente tipo a  nuestra disposición.";
  final preciossl = "150";
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          WidLabel(
            //response.map((e) => Text('${e.nombre}')).toString(),
            Texto: "Este F2P pasa por una fórmula rápida, inmediata accesible " +
                " y divertida, con una gran cantidad de tanques de diferente tipo a " +
                "nuestra disposición con los que competir en tensas batallas contra" +
                " otros jugadores. ",
            color: Colors.white,
          ),
          WidLabel(Texto: "150", color: Colors.white),
          WidButton(
